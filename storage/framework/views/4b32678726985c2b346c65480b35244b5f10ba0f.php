                    ...
                    <label for="country-dropdown" class="col-sm-2 col-form-label">NEGARA PENGAJIAN</label>
                     <div class="col-sm-6">
                       ...
                       <select name="country" id="country-dropdown" class="form-control" required>
                        ...
                        <option value="<?php echo e($edu->Kod_Negara); ?>"><?php echo e($edu->negara->Keterangan); ?> - (current)</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="state" id="state-dropdown" class="form-control" required>
                            <option value="<?php echo e($edu->Kod_State); ?>"><?php echo e($edu->state->NamaState); ?> - (current)</option>
                         </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="institusi" id="inst-dropdown" class="form-control" required>
                            <option value="<?php echo e($edu->Kod_Institusi); ?>"><?php echo e($edu->institusi->NamaInstitusi); ?> - (current)</option>
                           </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                       ...
                       <select name="Kod_Peringkat" class="form-control" required>
                        ...
                        <option value="<?php echo e($edu->Kod_Peringkat); ?>"><?php echo e($edu->peringkat->NamaPeringkat); ?> - (current)</option>
                    ...
                    <label for="bidang-dropdown" class="col-sm-2 col-form-label">BIDANG PENGAJIAN</label>
                     <div class="col-sm-6">
                       ...
                       <select name="bidang" id="bidang-dropdown" class="form-control" required>
                        ...
                        <option value="<?php echo e($edu->Kod_Bidang); ?>"><?php echo e($edu->bidang->NamaBidang); ?> - (current)</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="program" id="program-dropdown" class="form-control" required>
                            <option value="<?php echo e($edu->Kod_Program); ?>"><?php echo e($edu->program->NamaProgram); ?> - (current)</option>
                         </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                       ...
                       <select name="Kod_Penaja" class="form-control" required>
                        ...
                        <option value="<?php echo e($edu->Kod_Penaja); ?>"><?php echo e($edu->tajaan->NamaPenaja); ?> - (current)</option>
...
unset($__errorArgs, $__bag); ?>" name="TarikhMula" placeholder="Sila Isi Tarikh Mula Pengajian" value="<?php echo e($edu->TarikhMula); ?>" required autocomplete="TarikhMula">
...
unset($__errorArgs, $__bag); ?>" name="TarikhTamat" placeholder="Sila Isi Tarikh Tamat Pengajian" value="<?php echo e($edu->TarikhTamat); ?>" required autocomplete="TarikhTamat">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <select name="Kod_StatusPengajian" class="form-control" required>
                            ...
                            <option value="<?php echo e($edu->Kod_StatusPengajian); ?>"><?php echo e($edu->statuspengajian->Keterangan); ?> - (current)</option>
...
<?php echo $__env->make('std.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smpln2\resources\views/std/std-edu-update.blade.php ENDPATH**/ ?>