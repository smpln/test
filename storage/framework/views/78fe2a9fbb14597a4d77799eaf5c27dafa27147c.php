    ...
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion" style="background-color: #edeefd;">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <center>
                <img src="<?php echo e(asset('/storage/'.auth()->user()->ImageFile)); ?>" width="50" height="50">
                </center>
                <?php endif; ?>
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="<?php echo e(route('my-profile-password')); ?>">
                ...
                <div class="collapse" id="collapseCode" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('state.senarai')); ?>">
                ...
                <div class="collapse" id="collapseCode" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('institusi.senarai')); ?>">
                ...
                <div class="collapse" id="collapseCode" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('tajaan.senarai')); ?>">
                            <div class="sb-nav-link-icon"><i class="fa fa-university"></i></div>
                            Senarai Penaja
                        </a>
                     </nav>
                </div>
                <?php if(auth()->user()->KodLogin <> 'BPK'): ?>
                ...
                <div class="collapse" id="collapseCode1" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?php echo e(route('liputan.senarai')); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-flag"></i></div>
                            Senarai Wilayah
                        </a>
                     </nav>
...
<?php /**PATH C:\laragon\www\smpln2\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>