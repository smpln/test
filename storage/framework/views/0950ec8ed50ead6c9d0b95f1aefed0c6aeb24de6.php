        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="NoKadPengenalan" placeholder="No Kad Pengenalan" value="<?php echo e($waris->NoKadPengenalan); ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="NoKadPengenalan_Waris" placeholder="No Kad Pengenalan Waris" name="NoKadPengenalan_Waris" value="<?php echo e(old('NoKadPengenalan_Waris')); ?>" required>
                    </div>
                </div>
                <div class="form-group row">
...
<?php echo $__env->make('std.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smplnv2\resources\views/std/std-waris-create.blade.php ENDPATH**/ ?>