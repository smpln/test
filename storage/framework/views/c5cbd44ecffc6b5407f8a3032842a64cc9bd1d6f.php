    ...
    <div class="row">
        <div class="container">
            ...
            <div class="card">
                        ...
                        <?php if($edu->Kod_Negara == ""): ?>
                         ...
                         <?php else: ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('std-edu-show3',$edu->Id)); ?>" class="btn btn-primary">Lihat</a>
                                    </td>
                            </tr>
               ...
               <?php if($edu->Kod_Negara <> ""): ?>
                <center>
                     <a href="<?php echo e(route('std-edu-show2')); ?>" class="btn btn-primary"> Tambah Maklumat Pengajian </a>
                </center>
              <?php else: ?>
              <center>
...
<?php echo $__env->make('std.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smpln2\resources\views/std/std-edu-list.blade.php ENDPATH**/ ?>