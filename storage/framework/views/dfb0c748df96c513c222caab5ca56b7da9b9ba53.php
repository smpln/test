        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <?php endif; ?>
            <div class="card">
                <div class="card-header"><?php echo e(__('Kemaskini Maklumat Waris Saya')); ?></div>
...
unset($__errorArgs, $__bag); ?>"  maxlength="12" placeholder="No Kad Pengenalan Waris" name="NoKadPengenalan_Waris" value="<?php echo e($waris->NoKadPengenalan_Waris); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="Nama_Waris" placeholder="Nama Waris" name="Nama_Waris" value="<?php echo e($waris->Nama_Waris); ?>" required >
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="Alamat_Waris" placeholder="Sila Isi Alamat Waris" required autocomplete="Alamat_Waris"><?php echo e($waris->Alamat_Waris); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="Poskod_Waris" placeholder="Sila Isi Poskod Waris" value="<?php echo e($waris->Poskod_Waris); ?>" required autocomplete="Poskod_Waris">
...
unset($__errorArgs, $__bag); ?>" name="Bandar_Waris" placeholder="Sila Isi Bandar Waris" value="<?php echo e($waris->Bandar_Waris); ?>" required autocomplete="Bandar_Waris">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                           ...
                           <select name="Kod_NegeriWaris" class="form-control" required>
                            <option value="<?php echo e($waris->Kod_NegeriWaris); ?>"><?php echo e($waris->negeri->NamaNegeri); ?> - (current)</option>
                            ...
                            <?php if($waris->Kod_NegeriWaris != $n->Kod_Negeri): ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                       ...
                       <select name="Kod_NegaraWaris" class="form-control" required>
                        <option value="<?php echo e($waris->Kod_NegaraWaris); ?>"><?php echo e($waris->negara->Keterangan); ?> - (current)</option>
                        ...
                        <?php $__currentLoopData = $negara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <?php if($waris->Kod_NegaraWaris != $country->Kod_Negara): ?>
...
unset($__errorArgs, $__bag); ?>" name="NoTel_Waris" placeholder="Sila Isi No Telefon Waris" value="<?php echo e($waris->NoTel_Waris); ?>" required autocomplete="NoTel_Waris">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                       <select name="Hubungan_Waris" class="form-control" required>
                        <option value="<?php echo e($waris->Kod_Hubungan); ?>"><?php echo e($waris->hubungan->Keterangan); ?> - (current)</option>
                        <?php $__currentLoopData = $hubungan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <?php if($waris->Kod_Hubungan != $relationship->Kod_Hubungan): ?>
...
<?php echo $__env->make('std.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smplnv2\resources\views/std/std-waris-update.blade.php ENDPATH**/ ?>