        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input id="TarikhMula" type="date" class="form-control @error('TarikhMula') is-invalid @enderror" name="TarikhMula" placeholder="Sila Isi Tarikh Mula Pengajian" value="{{ old('TarikhMula') }}" required autocomplete="TarikhMula">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input id="TarikhTamat" type="date" class="form-control @error('TarikhTamat') is-invalid @enderror" name="TarikhTamat" placeholder="Sila Isi Tarikh Tamat Pengajian" value="{{ old('TarikhTamat') }}" required autocomplete="TarikhTamat">
