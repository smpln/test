        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    @endif
            <div class="card">
                <div class="card-header">{{ __('Kemaskini Maklumat Waris Saya') }}</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" id="NoKadPengenalan_Waris" class="form-control @error('NoKadPengenalan_Waris') is-invalid @enderror"  maxlength="12" placeholder="No Kad Pengenalan Waris" name="NoKadPengenalan_Waris" value="{{ $waris->NoKadPengenalan_Waris }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="Nama_Waris" placeholder="Nama Waris" name="Nama_Waris" value="{{ $waris->Nama_Waris }}" required >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" id="Alamat_Waris" rows="3" class="form-control @error('Alamat_Waris') is-invalid @enderror" name="Alamat_Waris" placeholder="Sila Isi Alamat Waris" required autocomplete="Alamat_Waris">{{ $waris->Alamat_Waris }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input id="Poskod_Waris" type="text" class="form-control @error('Poskod_Waris') is-invalid @enderror" name="Poskod_Waris" placeholder="Sila Isi Poskod Waris" value="{{ $waris->Poskod_Waris }}" required autocomplete="Poskod_Waris">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input id="Bandar_Waris" type="text" class="form-control @error('Bandar_Waris') is-invalid @enderror" name="Bandar_Waris" placeholder="Sila Isi Bandar Waris" value="{{ $waris->Bandar_Waris }}" required autocomplete="Bandar_Waris">
                    ...
                    <div class="col-sm-6">
                          {{-- <input type="text" class="form-control" id="KodNegeri" placeholder="Sila Pilih Negeri" value="" required>--}}
                           <select name="Kod_NegeriWaris" class="form-control" required>
                            <option value="{{ $waris->Kod_NegeriWaris }}">{{ $waris->negeri->NamaNegeri}} - (current)</option>
                            {{-- <option value="">Sila Pilih Negeri</option>--}}
                            @foreach ($negeri as $n)
                            @if($waris->Kod_NegeriWaris != $n->Kod_Negeri)
                    ...
                    <div class="col-sm-6">
                      ...
                      {{--<input type="text" class="form-control" id="KodNegara" placeholder="Sila Pilih Negara" value="" required>--}}
                       <select name="Kod_NegaraWaris" class="form-control" required>
                        <option value="{{ $waris->Kod_NegaraWaris }}">{{ $waris->negara->Keterangan}} - (current)</option>
                        {{-- <option value="">Sila Pilih Negara</option>--}}
                        @foreach ($negara as $country)
                           @if($waris->Kod_NegaraWaris != $country->Kod_Negara)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input id="NoTel_Waris" type="text" class="form-control @error('NoTel_Waris') is-invalid @enderror" name="NoTel_Waris" placeholder="Sila Isi No Telefon Waris" value="{{ $waris->NoTel_Waris }}" required autocomplete="NoTel_Waris">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                       <select name="Hubungan_Waris" class="form-control" required>
                        <option value="{{ $waris->Kod_Hubungan }}">{{ $waris->hubungan->Keterangan}} - (current)</option>
                        @foreach ($hubungan as $relationship)
                           @if($waris->Kod_Hubungan != $relationship->Kod_Hubungan)
                    ...
                    <button type="submit" class="btn btn-primary">Kemaskini Maklumat Waris</button>
                    </div>
                </form>
            </div>
        </div>
