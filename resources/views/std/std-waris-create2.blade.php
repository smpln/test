        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="NoKadPengenalan_Waris" placeholder="No Kad Pengenalan Waris" name="NoKadPengenalan_Waris" value="{{ old('NoKadPengenalan_Waris') }}" required>
                    </div>
                </div>
                <div class="form-group row">
